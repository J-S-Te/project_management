...
func (approvedContractVerifier) ListReferences(context.Context, string, int) ([]platform.ApprovedContract, string, error) {
	return []platform.ApprovedContract{{ID: "approved-1", Number: "HT-1", Version: 1}}, "", nil
}
